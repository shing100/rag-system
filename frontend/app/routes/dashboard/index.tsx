  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 justify-between">
            ...
            <div className="flex items-center">
              <span className="mr-4">안녕하세요, {user?.name}님</span>
              <button
                onClick={() => {
                  logout();
                  navigate('/');
                }}
                className="rounded-md bg-white px-3 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50"
              >
                로그아웃
              </button>
            </div>
      ...
      <div className="py-10">
        <header>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold leading-tight">대시보드</h1>
          </div>
        </header>
        <main>
                ...
                <div className="overflow-hidden rounded-lg bg-white shadow">
                  ...
                  <div className="bg-gray-50 px-5 py-3">
                    <div className="text-sm">
                      <Link to="/dashboard/projects" className="font-medium text-blue-700 hover:text-blue-900">
                        프로젝트 관리하기
                      </Link>
                    </div>
                  </div>
                ...
                <div className="overflow-hidden rounded-lg bg-white shadow">
                  <div className="p-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <dt className="text-sm font-medium text-gray-500 truncate">문서 수</dt>
                        <dd className="flex items-baseline">
                          <div className="text-2xl font-semibold text-gray-900">0</div>
                        </dd>
                      </div>
                ...
                <div className="overflow-hidden rounded-lg bg-white shadow">
                  <div className="p-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <dt className="text-sm font-medium text-gray-500 truncate">질의 수</dt>
                        <dd className="flex items-baseline">
                          <div className="text-2xl font-semibold text-gray-900">0</div>
                        </dd>
                      </div>
